# -*- coding: utf-8 -*-
#
# django-videos documentation build configuration file, created by
...
htmlhelp_basename = 'django-videosdoc'
...
latex_documents = [
  ('index', 'django-videos.tex', u'django-videos Documentation',
   u'Bearstech', 'manual'),
]
